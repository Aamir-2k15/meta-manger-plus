<div class="wrap">
    <h1>Add Admin Usermeta Fields</h1>
    <!-- . -->
    <?php
    $types = [
        'text' => 'Text',
    ...
    <div class="special-form">
        <form method="post" action="" style="display:inline;" id="reset_form">
            <?php 
                ...
                if (isset($_POST['reset_admin_usermeta_button'])) {
                    
                    $admin_usermeta_fields = get_option('admin_usermeta_fields', []); 

                    delete_option('admin_usermeta_fields', $admin_usermeta_fields);
                
                    // Display a success message
                    echo '<div class="updated"><p>Fields Reset</p></div>';
                }                             
            ?>
            <?php submit_button('Remove Admin Usermeta Fields', 'primary', 'reset_admin_usermeta_button'); ?>
        </form>
    </div>
    <div class="special-form">
